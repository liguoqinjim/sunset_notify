...
def baidu_ocr(image_filepath, api_key, secret_key):
    url = "https://aip.baidubce.com/rest/2.0/ocr/v1/accurate?access_token=" + _baidu_get_access_token(api_key, secret_key)
...
def download_sunset_image(rise=True,save_dir="temp"):
    ...
    target_url = "https://sunsetbot.top/static/media/cross_section/%E4%B8%8A%E6%B5%B7_rise.png"
    filename = "rise.png"
    if not rise:
